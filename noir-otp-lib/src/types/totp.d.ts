import { CreateHmacKey, HexString, KeyEncodings, SecretKey } from './utils';
 ...
 */
export declare const totpPadSecret: (secret: SecretKey, encoding: KeyEncodings, minLength: number) => HexString;
/**
